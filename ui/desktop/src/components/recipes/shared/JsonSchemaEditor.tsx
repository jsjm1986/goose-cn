  ...
  const handleSave = () => {
    if (localValue.trim()) {
      try {
        ...
        setLocalError(t('jsonSchemaEditor.invalidJson'));
        return;
      }
    }
    ...
    >
      <div className="bg-background-default border border-border-subtle rounded-lg p-6 w-[800px] max-w-[90vw] max-h-[90vh] overflow-hidden flex flex-col">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-medium text-text-standard">{t('jsonSchemaEditor.title')}</h3>
          <button
            type="button"
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <Button
                ...
                className="text-xs"
              >
                {t('jsonSchemaEditor.insertExample')}
              </Button>
            </div>
