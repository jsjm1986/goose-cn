/**
 * AGIME Logo - AI + Me
 * A modern, elegant logo representing the harmonious connection between AI and human
 * Design: Interlocking rings symbolizing unity and collaboration
 */
export function AgimeLogo({ className = '' }) {
  return (
    <svg
      width="24"
      height="24"
      ...
      className={className}
    >
      {/* AI Ring - Left circle with tech-inspired cut */}
      <path
        ...
        strokeLinecap="round"
      />
      {/* Me Ring - Right circle representing human */}
      <path
        ...
        strokeLinecap="round"
      />
      {/* Connection point - where AI meets Me */}
      <circle
        cx="12"
        cy="12"
        r="2.5"
