...
export default function ExtensionModal({
  ...
  const modalTitle = showDeleteConfirmation ? t('modal.deleteExtension', { name: formData.name }) : title;
    ...
    <>
      ...
      {showCloseConfirmation && (
        <ConfirmationModal
          ...
          message={t('modal.unsavedChangesMessage')}
          confirmLabel={t('modal.closeWithoutSaving')}
