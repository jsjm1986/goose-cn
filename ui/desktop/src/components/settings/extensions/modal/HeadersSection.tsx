...
export default function HeadersSection({
  ...
  const handleAdd = () => {
    ...
    if (keyEmpty || valueEmpty) {
      ...
      setValidationError(t('headers.bothRequired'));
      return;
    }
    ...
    if (keyHasSpaces) {
      ...
      setValidationError(t('headers.noSpaces'));
      return;
    }
  ...
  return (
    <div>
      <div className="relative mb-2">
        <label className="text-sm font-medium text-textStandard mb-2 block">{t('headers.title')}</label>
