...
function ToolDetailsView({ toolCall, isStartExpanded }: ToolDetailsViewProps) {
  ...
  return (
    <ToolCallExpandable
      label={<span className="pl-4 font-sans text-sm">{t('toolCall.toolDetails')}</span>}
...
function ToolResultView({ result, isStartExpanded }: ToolResultViewProps) {
  ...
  return (
    <ToolCallExpandable
      label={<span className="pl-4 py-1 font-sans text-sm">{t('toolCall.output')}</span>}
      isStartExpanded={isStartExpanded}
    >
