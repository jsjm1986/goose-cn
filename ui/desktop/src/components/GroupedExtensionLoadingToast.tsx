                      ...
                      <div className="ml-7 flex flex-col gap-2">
                        ...
                        {ext.recoverHints && setView ? (
                          ...
                          <Button
                            ...
                            className="self-start"
                          >
                            {copiedExtension === ext.name ? t('loading.copied') : t('loading.copyError')}
                          </Button>
                        )}
                      </div>
                    )}
          ...
          {totalCount > 0 && (
            <CollapsibleTrigger asChild>
              <button
                ...
                aria-label={isOpen ? t('loading.collapseDetails') : t('loading.expandDetails')}
              >
                {isOpen ? (
                  <>
                    <span>{t('loading.showLess')}</span>
                    <ChevronUp className="w-3 h-3" />
                  </>
                ) : (
                  <>
                    <span>{t('loading.showDetails')}</span>
